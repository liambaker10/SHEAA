...
task, model_and_task, bit_error_rate, seed = 'xsum', 'brutusxu/t5-base-finetuned-xsum', 1e-7, 0
...
with torch.no_grad():
    ...
    injector = Injector(param_names = ['shared'], p = float(bit_error_rate), device = device, seed = seed, verbose = True)
