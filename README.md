...
All of our error injectors are doing their injection by attacking the indivdual nodes in a given NLP model. In our [important folders](important functions/) we have starter code for a few models that can help you get going. 
